        ...
        ThreadPoolManager.getInstance().executeTask(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mIPosPrinterService.printSpecifiedTypeText("--------------------------------\n", "ST", 24, callbackPPT8555);
                    mIPosPrinterService.setPrinterPrintAlignment(1, callbackPPT8555);
                    mIPosPrinterService.printSpecifiedTypeText("Sales Detail\n", "ST", 32, callbackPPT8555);
            ...
            public void run() {
                try {
                    for (int k = 0; k < Integer.parseInt(settings.get_No_Of_Print()); k++) {
                        ...
                        mIPosPrinterService.printSpecifiedTypeText("" + Globals.objLPR.getCompany_Name() + "\n", "ST", 32, callbackPPT8555);
                        mIPosPrinterService.printSpecifiedTypeText(" \n", "ST", 32, callbackPPT8555);
                        mIPosPrinterService.printSpecifiedTypeText("Z Report\n", "ST", 32, callbackPPT8555);
                        mIPosPrinterService.setPrinterPrintAlignment(0, callbackPPT8555);
                        ...
                        while (iPayCount < arrPaymentAmount.size()) {
                            strTotal = Globals.myNumberFormat2Price(Double.parseDouble(arrPaymentAmount.get(iPayCount)), decimal_check);
                            mIPosPrinterService.printSpecifiedTypeText(arrPaymentName.get(iPayCount)+" : "+expenses,"ST",24,callbackPPT8555);
                            iPayCount++;
                        }
