...
//        aesHelper = new AESHelper();
        ...
        String cntryid = lite_pos_registration.getCountry_Id();
    ...
    private String profile_on_server() {
        ...
        HttpPost httpPost = new HttpPost(
                "http://" + Globals.App_IP + "/lite-pos/index.php/api/register/update");
...
//                nameValuePairs.add(new BasicNameValuePair("device_code", Globals.Device_Code));
                nameValuePairs.add(new BasicNameValuePair("device_code", "VS02184G50980"));
            }
            httpPost.setEntity(new UrlEncodedFormEntity(nameValuePairs));
        } catch (UnsupportedEncodingException e1) {
            // TODO Auto-generated catch block
